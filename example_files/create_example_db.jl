...
s8=Stock(named_id("iron_nitrate"),primary_comp[findfirst(x->x.name=="iron_nitrate",primary_comp)],2500u"g",Labware(id(),containers[findfirst(x->x.name=="iron_nitrate",containers)],"chemical shelf",today()),1,true)
